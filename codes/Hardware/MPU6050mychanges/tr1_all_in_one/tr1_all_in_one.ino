...
void loop() {
  ...
  if(initial_boolean==1)
  {
    ...
    //Serial.println("passzzzed");
     ...
     //Serial.println(initial_array[0]);
  ...
  {
   //wating_array[10]=1;//gForceX;
    waiting_counter++;
//    wating_array[2]=2;//gForceY;
   waiting_counter++;
//    wating_array[3]=3;//gForceZ;
    waiting_counter++;
...
////      }
     initial_boolean=1;
     Serial.println("passsssaaasssssaaaaasdasded");
     delay(1000);
    }
